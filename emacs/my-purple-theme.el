...
(custom-theme-set-faces
 ...
 '(warning ((t (:weight bold :foreground "#FF8080"))))
 ...
 '(mode-line ((t (:box (:line-width (8 . 4) :color "#1A1821" :style nil) :foreground "#E7E4F2" :background "#1A1821"))))
 '(mode-line-inactive ((t (:box (:line-width (8 . 4) :color "#1A1821" :style nil) :foreground "#A08BEF" :background "#1A1821"))))
 ...
 '(evil-ex-substitute-matches ((t (:strike-through t :foreground "#FF5656"))))
 '(evil-ex-substitute-replacement ((t (:foreground "#56FF56"))))
 '(evil-ex-info ((t (:inherit (minibuffer-prompt)))))
 '(rainbow-delimiters-depth-1-face ((t (:foreground  "#7FBFFF"))))
 '(rainbow-delimiters-depth-2-face ((t (:foreground  "#7FFFBF"))))
 '(rainbow-delimiters-depth-3-face ((t (:foreground  "#BFFF7F"))))
 '(rainbow-delimiters-depth-4-face ((t (:foreground  "#FFBF7F"))))
 '(rainbow-delimiters-depth-5-face ((t (:foreground  "#FF7FBF"))))
 '(rainbow-delimiters-depth-6-face ((t (:foreground  "#BF7FFF"))))
