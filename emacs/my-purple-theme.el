...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:box (:line-width (8 . 4) :color "#1A1821" :style nil) :background "#1A1821" :foreground "#D7CDFF"))))
 '(mode-line-inactive ((t (:box (:line-width (8 . 4) :color "#1A1821" :style nil) :background "#1A1821" :inherit (shadow)))))
 ...
 '(evil-ex-info ((t (:inherit (minibuffer-prompt)))))
 '(woman-bold ((t (:foreground "#A08BEF" :inherit (bold)))))
 '(woman-italic ((t (:foreground "#66CCCC" :inherit (italic)))))
 ...
 '(eshell-ls-directory ((t (:inherit (font-lock-constant-face)))))
 '(eshell-ls-special ((t (:foreground "#FF80FF"))))
 '(eshell-ls-symlink ((t (:foreground "#80FFFF"))))
 '(eshell-ls-archive ((t (:foreground "#8080FF"))))
 '(eshell-syntax-highlighting-shell-command-face ((t (:inherit (font-lock-type-face)))))
 '(eshell-syntax-highlighting-alias-face ((t (:inherit (font-lock-preprocessor-face)))))
 '(eshell-syntax-highlighting-file-arg-face ((t (:inherit (font-lock-constant-face)))))
 '(eshell-syntax-highlighting-directory-face ((t (:inherit (font-lock-constant-face)))))
